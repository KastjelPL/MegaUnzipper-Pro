      ...
      <div className="relative max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8 pb-32">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            <a
              href="https://github.com/KastjelPL/MegaUnzipper-Pro"
              target="_blank"
              rel="noopener noreferrer"
              className="px-4 py-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-sm tracking-wide shadow-lg border border-white/10 transition-all hover:scale-105 active:scale-[0.98] flex items-center justify-center"
